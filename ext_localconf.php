...
if (TYPO3_MODE == 'BE') {
//	$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['processCmdmapClass'][$_EXTKEY] = 'EXT:' . $_EXTKEY . '/class.tx_ddgooglesitemap_tcemain.php:&tx_ddgooglesitemap_tcemain';
